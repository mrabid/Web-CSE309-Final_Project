...
if(isset($_POST['send'])){
   ...
   if(mysqli_num_rows($select_message) > 0){
      ...
      $message[] = 'message sent successfully . Please Wait For Confirmation mail';
   }
...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <textarea name="message" class="box" placeholder="Type what type of delivery job you want " id="" cols="30" rows="10"></textarea>
